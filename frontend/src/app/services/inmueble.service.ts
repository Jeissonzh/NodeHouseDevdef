...
export class InmuebleService {
  ...
  getBusqueda(habitaciones:Number,banos:Number) {
    //const busqueda = `http://localhost:3000/inmuebles/busqueda?habitaciones=1&banos=1`;
    //console.log(busqueda)
    return this.httpClient.get(`http://localhost:3000/inmuebles/busqueda?habitaciones=${habitaciones}&banos=${banos}`)
  }
}
