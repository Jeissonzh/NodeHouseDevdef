...
export class BusquedaComponent implements OnInit {
  ...
  clickConsultar():void{
    console.log('hola!x2'),
    this.inmuebleService.getBusqueda(this.inmueble.habitaciones,this.allInmueblesB,this.allInmueblesPa,this.allInmueblesPi,this.allInmueblesS,this.allInmueblesPr,this.allInmueblesCI).subscribe((data)=>{
